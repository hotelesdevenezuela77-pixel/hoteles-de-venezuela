...
export function RoomCard({ room, onReserve }: RoomCardProps) {
  ...
  return (
    <div className="group bg-card overflow-hidden shadow-lg hover:shadow-2xl transition-all duration-500 border border-border/50 rounded-3xl">
      {/* Image Carousel */}
      <div className="relative h-72 sm:h-80 overflow-hidden">
        ...
        <div className="absolute bottom-4 left-4 right-20">
          <h3 className="text-white text-2xl font-luxury tracking-tight">{room.title}</h3>
        </div>
      ...
      <div className="p-6">
        ...
        {/* Description */}
        <p className="text-muted-foreground mb-4 leading-relaxed min-h-[60px] font-cursive text-base">
          {room.description}
        </p>
        ...
        <Button 
          ...
          className="w-full gradient-gold text-stone-900 font-semibold rounded-full transition-all duration-300 hover:scale-105 border-0 flex items-center justify-center gap-2"
        >
