...
const roomTypes = [
  { 
    ...
    description: '4 personas • Ideal para familias pequeñas',
    icon: Users
  },
  { 
    id: 'Familiar Grande', 
    label: 'Habitación Familiar Grande', 
    description: '6 personas • Amplia y cómoda',
    icon: Users
  },
  { 
    id: 'Extrafamiliar', 
    label: 'Habitación Extrafamiliar', 
    description: '8 personas • Para grupos grandes',
    icon: Home
  },
  { 
    id: 'Ejecutiva', 
    label: 'Habitación Ejecutiva', 
    description: '2 personas • Confort y elegancia',
    icon: Bed
  },
  { 
    id: 'No estoy seguro', 
      ...
      <div className="relative w-full max-w-md bg-white rounded-3xl shadow-2xl overflow-hidden animate-in zoom-in-95 duration-200">
        ...
        <div className="bg-[#075E54] px-6 py-4 flex items-center gap-4">
          ...
          <div className="flex-1">
            <h3 className="text-white font-semibold text-lg">Posada Perla Negra</h3>
