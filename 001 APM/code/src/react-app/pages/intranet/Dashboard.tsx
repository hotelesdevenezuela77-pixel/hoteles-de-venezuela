...
export default function Dashboard() {
  ...
  const fetchStats = async () => {
    ...
    try {
      ...
      const occupancyRate = Math.round((activeReservations / 20) * 100);
    ...
    <div className="pb-16">
      ...
      <div className="mb-6 sm:mb-8">
        ...
        <p className="text-slate-500 mt-1 text-sm sm:text-base">
          Panel de Administración - Aparto Posada del Mar
        </p>
      </div>
      ...
      {loading ? (
        ...
        <>
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-6 mb-6 sm:mb-8">
            ...
            >
              <Starfish className="absolute -top-2 -right-2 w-12 sm:w-16 h-12 sm:h-16 text-cyan-100" />
              <div className="relative">
                <div className="flex items-center gap-1 sm:gap-2 mb-1">
                  <BedDouble className="w-4 sm:w-5 h-4 sm:h-5 text-cyan-500" />
                ...
                <p className="text-cyan-600 text-xs sm:text-sm mt-2">{stats.totalRooms} habitaciones</p>
              </div>
            </div>
            ...
            <div 
              ...
              className="bg-white rounded-xl sm:rounded-2xl p-4 sm:p-6 shadow-sm border border-slate-200 relative overflow-hidden cursor-pointer hover:shadow-md transition-shadow"
            >
              <ShipWheel className="absolute -top-2 -right-2 w-12 sm:w-16 h-12 sm:h-16 text-teal-100" />
              <div className="relative">
                <div className="flex items-center gap-1 sm:gap-2 mb-1">
            ...
            <div 
              ...
              className="bg-white rounded-xl sm:rounded-2xl p-4 sm:p-6 shadow-sm border border-slate-200 relative overflow-hidden cursor-pointer hover:shadow-md transition-shadow"
            >
              <TropicalFish className="absolute -top-2 -right-2 w-12 sm:w-16 h-12 sm:h-16 text-amber-100" />
              <div className="relative">
                <div className="flex items-center gap-1 sm:gap-2 mb-1">
            ...
            <div 
              ...
              className="bg-white rounded-xl sm:rounded-2xl p-4 sm:p-6 shadow-sm border border-slate-200 relative overflow-hidden cursor-pointer hover:shadow-md transition-shadow"
            >
              <Seahorse className="absolute -top-2 -right-2 w-12 sm:w-16 h-12 sm:h-16 text-purple-100" />
              <div className="relative">
                <div className="flex items-center gap-1 sm:gap-2 mb-1">
          ...
          <div className="bg-white rounded-xl sm:rounded-2xl p-4 sm:p-6 shadow-sm border border-slate-200 mb-6 sm:mb-8">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 sm:gap-4">
              <button
                onClick={() => navigate("/smarthecosystems/reservaciones")}
                className="flex items-center gap-3 p-4 bg-gradient-to-r from-cyan-500 to-teal-500 text-white rounded-xl hover:opacity-90 transition-opacity"
              >
              ...
              <button
                onClick={() => navigate("/smarthecosystems/crm")}
                className="flex items-center gap-3 p-4 bg-gradient-to-r from-sky-500 to-blue-600 text-white rounded-xl hover:opacity-90 transition-opacity"
              >
