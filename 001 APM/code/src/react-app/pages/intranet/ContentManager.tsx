...
export default function ContentManager() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-sky-950 to-slate-900 p-3 sm:p-6">
      ...
      <div className="max-w-5xl mx-auto">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-8">
          <div>
            ...
            <p className="text-cyan-300 mt-1 text-sm sm:text-base">Edita el contenido de la página de inicio</p>
          </div>
        ...
        <div className="space-y-6">
          {sectionOrder.map(section => {
            ...
            return (
              <div key={section} className="bg-slate-800/50 backdrop-blur-sm rounded-xl border border-cyan-500/20 overflow-hidden">
                {/* Section Header */}
                <button
                            ...
                            <div className="space-y-3">
                              ...
                              <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-3">
                                ...
                                <button
                                  ...
                                  className="w-full h-24 border-2 border-dashed border-cyan-500/40 rounded-lg flex flex-col items-center justify-center text-cyan-400 hover:border-cyan-400 hover:bg-cyan-500/10 transition-colors"
                                >
                            ...
                            <div className="flex flex-col gap-3">
                              {item.content_key.includes('subtitle') || item.content_key.includes('description') ? (
                                <textarea
                                  value={currentValue}
                                  onChange={(e) => handleContentChange(item.id, e.target.value)}
                                  className="flex-1 bg-slate-800 border border-slate-600 rounded-lg px-4 py-2 text-white focus:border-cyan-500 focus:outline-none min-h-[80px] resize-y"
      ...
      {/* Footer Credit */}
      <div className="text-center py-6 border-t border-slate-700 mt-8">
        <p className="text-slate-400 text-sm">
          Tecnología desarrollada por <span className="font-semibold text-slate-300">Webmasterpro Entertainment Corporation</span>
        </p>
        <p className="text-slate-400 text-sm">
          Smarth Eco Systems — <span className="text-cyan-400">Israel de Jesús</span>
        </p>
      </div>
    </div>
  );
